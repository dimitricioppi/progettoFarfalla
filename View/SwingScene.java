...
public class SwingScene {
    ...
    public SwingScene(GameState gameState, int w, int h, double width, double height){
    ...
    private class ScenePanel extends JPanel implements KeyListener{
        ...
        public void paint(Graphics g){
            ...
            if (gameState.isGameOver()){
                ...
                String text = """
                            ...
                            Use the four arrow keys to move the butterfly in the game world.\n
                            Be carefull as the butterfly needs time to both move and stop as well as turning.\n
                            You start with 3 lifes and 0 points: if you touch an enemy you will lose 1 life and that enemy will disappear.\n
                            Be carefull in this game getting hurt doesn't give invicibility frames an if you reach 0 lives, the game ends.\n
                            In the game you will find varius pick-ups to make points an help you, they are:\n
                              
                            1- Blue Flower   : gives 10 points.\n
                            2- Red Flower    : gives 30 points.\n
                            3- Bomb          : gives 10 points and will send a homing projectile to kill the nearest enemy (if present).\n
                            4- Life Heart    : gives 50 points and 1 extra life.\n
                            ...
                            1- Black Bat     : the most basic one, it moves in 1 direction bouncing on the edges of the game world.\n
                            2- Dragonfly     : spawned by the Curse Star, it will randomly change direction 2 times per second.\n
                            3- Red Bat       : the rarest an most dangerous one, it will slowily follow the butterfly.\n

                            Take note that the number of pick-ups and enemies will grow based on the number of pick-ups taken.\n
                            The more pick-ups you have taken, the more difficult the game will be and the more points you will make.""";
        ...
        public void keyPressed(KeyEvent e) {
            ...
            for (KeyboardInputController ctrl: gameState.getEngine().getKeyboardInputControllers()) {
