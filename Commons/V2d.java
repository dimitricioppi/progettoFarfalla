...
public class V2d implements Serializable {
    ...
    public V2d(){
        ...
        x2 = RandomGenerator.RandomBoundedN(0, (Math.pow(STANDARD_VEL, 2)-1));
        y2 = (int) Math.pow(STANDARD_VEL, 2)-x2;
        
        this.x = RandomGenerator.RandomBoolean()?Math.sqrt(x2):-(Math.sqrt(x2));
        this.y = RandomGenerator.RandomBoolean()?Math.sqrt(y2):-(Math.sqrt(y2));
