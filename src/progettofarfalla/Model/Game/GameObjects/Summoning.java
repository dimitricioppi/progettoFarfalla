...
import progettofarfalla.Model.Imputs.RedBatInputComponent;
import progettofarfalla.Model.Imputs.NullInputComponent;
import progettofarfalla.Model.Imputs.InputComponent;
import progettofarfalla.Model.Imputs.DragonflyInputComponent;
...
public class Summoning implements GameObject{
    ...
    public static enum Type { SUMMON }
    ...
    public Summoning(Type type, P2d pos, V2d vel, BoundingBox box, InputComponent input,
    ...
    public void summonEntity(){
        ...
        if(this.summon == Entity.Type.BLACK_BAT){
            ...
            this.world.addEnemy(f.createEnemy(Entity.Type.BLACK_BAT, pos, radius, new V2d(),
                                new NullInputComponent(), new BatGraphicsComponent(false)));
        }

        if(this.summon == Entity.Type.DRAGONFLY){

            this.world.addEnemy(f.createEnemy(Entity.Type.DRAGONFLY, pos, radius, new V2d(),
                                new DragonflyInputComponent(), new DragonflyGraphicsComponent()));
        }

        if(this.summon == Entity.Type.RED_BAT){

            this.world.addEnemy(f.createEnemy(Entity.Type.RED_BAT, pos, radius, new V2d(),
